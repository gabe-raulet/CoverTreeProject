...
all: create_points point_info pindex_graph graph_diff build_rgraph
...
clean:
	rm -rf *.dSYM test_itree test_vcell test_indexers test_graphutils create_points point_info pindex_graph graph_diff build_rgraph
